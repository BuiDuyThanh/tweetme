...
class TweetListAPIView(generics.ListAPIView):
	...
	def get_queryset(self, *args, **kwargs):
		requested_user = self.kwargs.get("username")	# get username from url : /api/username/tweet/
		if requested_user:
			...
			qs = (qs1 | qs2).distinct().order_by("-timestamp")	# combine both queryset (including Main user's and Following user's tweets)
